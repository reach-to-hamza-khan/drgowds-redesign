...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 overflow-hidden flex flex-col items-center justify-center min-h-screen text-center">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
                ...
                >
                    ...
                    <span className="text-xs font-bold text-gray-300 tracking-[0.2em] uppercase">Premium Dental Care</span>
                </motion.div>
                ...
                >
                    Best Dental <br className="hidden md:block" />
