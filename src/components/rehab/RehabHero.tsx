...
export default function RehabHero() {
    ...
    return (
        <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 overflow-hidden flex flex-col items-center justify-center min-h-screen text-center">
            ...
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-red-600/30 rounded-full blur-[150px] -z-10 mix-blend-screen animate-pulse" />
            <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-indigo-600/20 rounded-full blur-[150px] -z-10 mix-blend-screen" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
                ...
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8 shadow-2xl shadow-red-500/20"
                >
                    <span className="w-2 h-2 rounded-full bg-red-500 animate-ping"></span>
                    <span className="text-xs font-bold text-gray-300 tracking-[0.2em] uppercase">Full Mouth Rehabilitation</span>
                </motion.div>
                ...
                >
                    Rebuild Your Smile, <br className="hidden md:block" />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-indigo-500 drop-shadow-[0_0_20px_rgba(239,68,68,0.3)]">Restore Your</span> Confidence
                </motion.h1>
                ...
                >
                    {features.map((feature, i) => (
                        <div key={i} className="flex flex-col items-center justify-center p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl hover:bg-white/10 transition-colors group">
                            <feature.icon className="w-8 h-8 text-red-500 mb-3 group-hover:scale-110 transition-transform" />
