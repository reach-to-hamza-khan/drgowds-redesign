...
export default function RootCanalComparison() {
    const comparisons = [
        {
            feature: "Instrument",
            others: "General Hand instrument.",
            drGowds: "Best Machine wave ones."
        },
        {
            feature: "Basic technology",
            others: "X-Rays, clean and filling.",
            drGowds: "Endo-motor driven root canal filling."
        },
        {
            feature: "Expertise",
            others: "General Dentist in basic clinics.",
            drGowds: "Endodontist (Root canal specialist)."
        },
        {
            feature: "Precision",
            others: "Depending on Hand instrument.",
            drGowds: "Operating Microscope 100% RCT."
        },
        {
            feature: "Symptom",
            others: "May fall ill again.",
            drGowds: "Treating deep root / no more fall ill."
        }
    ];
    ...
    return (
        <section className="py-32 bg-[#030014] relative overflow-hidden">
            ...
            {/* Background Decor */}
            <div className="absolute top-1/2 left-0 w-full h-[600px] bg-purple-900/10 -z-10 -skew-y-12" />

            <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8">

                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
                    <div className="max-w-xl">
                        <p className="text-purple-500 font-bold uppercase tracking-[0.3em] text-sm mb-4">Compare To The Rest</p>
                        <motion.h2
                        ...
                        >
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500 drop-shadow-[0_0_20px_rgba(168,85,247,0.3)]">Dr. Gowd's ?</span>
                        </motion.h2>
                    </div>
                    <p className="text-gray-400 font-medium max-w-sm mb-2 leading-relaxed">
                        Experience the absolute premium standard in Endodontics. See how our specialized Root Canal approach compares to others.
                    </p>
                </div>
                    ...
                    {comparisons.map((row, i) => (
                        ...
                        >
                            ...
                            <div className="bg-white/5 p-8 lg:p-12 pt-16 lg:pt-20 flex flex-col justify-end min-h-[200px] relative overflow-hidden group-hover:bg-white/10 transition-colors">
                                ...
                                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-purple-500 via-pink-500 to-transparent opacity-50 block shadow-[0_0_15px_rgba(168,85,247,1)]" />
                                <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />

                                <div className="relative z-10">
                                    <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center mb-6 border border-purple-500/50 shadow-[0_0_15px_rgba(168,85,247,0.4)]">
                                        <Check className="w-5 h-5 text-purple-500" />
                                    </div>
                                    <h4 className="text-white font-black text-xl mb-2 flex items-center gap-2">
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">Dr. Gowd's</span>
                                    </h4>
