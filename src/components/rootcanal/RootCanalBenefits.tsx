...
export default function RootCanalBenefits() {
    const services = [
        {
            title: "Saves Natural Teeth",
            description: "Preserves your natural tooth structure for chewing and speaking.",
            bg: "from-pink-500/20 to-purple-500/20",
            border: "border-pink-500/30",
        },
        {
            title: "Stops Infection",
            description: "Eliminates bacteria and prevents further infection spread.",
            bg: "from-blue-500/20 to-cyan-500/20",
            border: "border-blue-500/30",
        },
        {
            title: "Boosts Oral Health",
            description: "Restores normal function and promotes overall oral hygiene.",
            bg: "from-emerald-500/20 to-teal-500/20",
            border: "border-emerald-500/30",
        },
        {
            title: "Pain Relief",
            description: "Relieves the severe pain caused by tooth decay.",
        ...
        <section className="py-24 bg-[#030014] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4 border-b border-white/10 pb-8">
                    <div>
                        <p className="text-purple-500 font-bold tracking-[0.3em] uppercase text-sm mb-4">Benefits of Root Canal</p>
                        <motion.h2
                        ...
                        >
                            The Clear Choice <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500 drop-shadow-[0_0_20px_rgba(168,85,247,0.3)]">for Perfecting</span> <span className="text-gray-500">Your Smile</span>
                        </motion.h2>
                    </div>
