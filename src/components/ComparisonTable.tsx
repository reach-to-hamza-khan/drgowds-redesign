...
const comparisons = [
    {
        ...
        others: "General dentists handling complex cases across all domains.",
        drGowds: "Specialists for each branch of dentistry."
    },
    {
        feature: "Implant Quality",
        others: "Local or unbranded implants to save cost.",
        drGowds: "Top-tier, globally recognized implant brands."
    },
    {
        feature: "Technology & Diagnostics",
        others: "Basic 2D imaging and traditional impression techniques.",
        drGowds: "Advanced 3D CBCT, intraoral scanners, and digital planning."
    },
    {
        feature: "Working Philosophy",
        others: "High patient volume over personalized care.",
        drGowds: "Priority on quality, longevity, and patient comfort."
    },
    {
        feature: "Patient Journey & Support",
        others: "Minimal post-treatment follow-up and unorganized care management.",
        drGowds: "Dedicated care managers, detailed treatment plans, and lifetime support."
    }
];
            ...
            <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
                    ...
                    <p className="text-gray-400 font-medium max-w-sm mb-2 leading-relaxed">
                        Experience the absolute premium standard in oral care. See how our specialized approach compares to standard clinics.
                    </p>
                </div>
                    ...
                    {comparisons.map((row, i) => (
                        ...
                        >
                            ...
                            <div className="bg-white/[0.02] p-8 lg:p-12 pt-16 lg:pt-20 flex flex-col justify-end min-h-[200px] border-b md:border-b-0 md:border-r border-white/5 transition-colors group-hover:bg-red-500/5">
                                ...
                                <h4 className="text-white/40 font-black text-xl mb-2">Other Clinics</h4>
