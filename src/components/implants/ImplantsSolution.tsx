...
export default function ImplantsSolution() {
    const features = [
        { text: "A real like experience!", icon: <Check className="w-5 h-5 text-white" /> },
        { text: "Long-lasting replacement!", icon: <Check className="w-5 h-5 text-white" /> },
        { text: "Bypass all missing teeth problems", icon: <Check className="w-5 h-5 text-white" /> }
    ];
                    ...
                    >
                        <div>
                            ...
                            <h2 className="text-5xl lg:text-7xl font-black text-white tracking-tighter leading-[1.05]">
                                The Ultimate <span className="text-gradient">Solution</span> <br />
                    ...
                    >
                        ...
                        <div className="aspect-square max-w-lg mx-auto rounded-full p-2 border border-white/10 bg-white/5 backdrop-blur-3xl shadow-[0_0_100px_rgba(236,72,153,0.15)] relative animate-[spin_60s_linear_infinite]">
                            <div className="w-full h-full rounded-full border border-dashed border-white/20 animate-[spin_40s_linear_infinite_reverse] p-4">
                                <div className="w-full h-full rounded-full bg-[url('https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-60 mix-blend-screen" />
                            </div>
                        </div>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-2xl p-8 rounded-3xl border border-white/20 text-center shadow-2xl">
                            <HeartPulse className="w-16 h-16 text-pink-500 mb-4 mx-auto drop-shadow-[0_0_15px_rgba(236,72,153,0.8)]" />
                            <p className="text-white font-bold tracking-widest uppercase text-sm">Dental Implant System</p>
                        </div>
                    </motion.div>
