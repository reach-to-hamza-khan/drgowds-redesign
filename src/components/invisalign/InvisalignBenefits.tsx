    ...
    const services = [
        {
            ...
            description: "No brackets or wires to cause irritation in your mouth.",
            bg: "from-pink-500/20 to-purple-500/20",
            border: "border-pink-500/30",
        },
        {
            title: "Faster transformations",
            description: "See results sooner with our proven clear aligner therapy.",
            bg: "from-blue-500/20 to-cyan-500/20",
            border: "border-blue-500/30",
        },
        {
            title: "Exclusivity",
            description: "Only certified Invisalign providers can offer this treatment.",
            bg: "from-emerald-500/20 to-teal-500/20",
            border: "border-emerald-500/30",
        },
        {
            title: "Convenience",
            description: "Fewer orthodontic visits compared to traditional braces.",
        ...
        <section className="py-24 bg-[#030014] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4 border-b border-white/10 pb-8">
                    <div>
                        <p className="text-teal-400 font-bold tracking-[0.3em] uppercase text-sm mb-4">Benefits of Invisalign</p>
                        <motion.h2
                        ...
                        >
                            The Clear Choice <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500 drop-shadow-[0_0_20px_rgba(45,212,191,0.3)]">for Perfecting</span> <span className="text-gray-500">Your Smile</span>
                        </motion.h2>
                    </div>
