...
export default function InvisalignHero() {
    ...
    return (
        <section id="hero-invisalign" className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 overflow-hidden flex flex-col items-center justify-center min-h-screen text-center">

            {/* Dynamic Background Glowing Orbs */}
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-600/30 rounded-full blur-[150px] -z-10 mix-blend-screen animate-pulse" />
            <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-teal-600/20 rounded-full blur-[150px] -z-10 mix-blend-screen" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
                ...
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8 shadow-2xl shadow-teal-500/20"
                >
                    <span className="w-2 h-2 rounded-full bg-teal-400 animate-ping"></span>
                    <span className="text-xs font-bold text-gray-300 tracking-[0.2em] uppercase">Invisaligners</span>
                </motion.div>
                ...
                >
                    Best Invisalign <br className="hidden md:block" />
                    <span className="text-gradient">Dentists in</span> Hyderabad!
                </motion.h1>
