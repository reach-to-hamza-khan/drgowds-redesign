...
export default function InvisalignComparison() {
    const comparisons = [
        {
            feature: "Comfort",
            others: "Bulky wires and brackets.",
            drGowds: "Smooth, custom fit."
        },
        {
            feature: "Aesthetics",
            others: "Highly noticeable.",
            drGowds: "Virtually invisible."
        },
        {
            feature: "Removability",
            others: "Fixed to your teeth.",
            drGowds: "Removable for eating & cleaning."
        },
        {
            feature: "Treatment Time",
            others: "As fast as mild changes.",
            drGowds: "Faster for mild changes."
        },
        {
            feature: "Maintenance",
            others: "Requires special care.",
            drGowds: "Easy to clean."
        }
    ];
            ...
            <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
                    <div className="max-w-xl">
                        <p className="text-teal-400 font-bold uppercase tracking-[0.3em] text-sm mb-4">Compare To The Rest</p>
                        <motion.h2
                        ...
                        >
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500 drop-shadow-[0_0_20px_rgba(45,212,191,0.3)]">Invisalign ?</span>
                        </motion.h2>
                    </div>
                    <p className="text-gray-400 font-medium max-w-sm mb-2 leading-relaxed">
                        See why clear aligners are the superior choice compared to traditional braces for your smile transformation.
                    </p>
                </div>
                    ...
                    {comparisons.map((row, i) => (
                        ...
                        >
                            ...
                            <div className="bg-white/[0.02] p-8 lg:p-12 pt-16 lg:pt-20 flex flex-col justify-end min-h-[200px] border-b md:border-b-0 md:border-r border-white/5 transition-colors group-hover:bg-red-500/5">
                                ...
                                <h4 className="text-white/40 font-black text-xl mb-2">Traditional Braces</h4>
                                <p className="text-gray-500 font-medium leading-relaxed">{row.others}</p>
                            </div>

                            {/* Right Side: Invisalign */}
                            <div className="bg-white/5 p-8 lg:p-12 pt-16 lg:pt-20 flex flex-col justify-end min-h-[200px] relative overflow-hidden group-hover:bg-white/10 transition-colors">
                                ...
                                <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-teal-400 via-blue-500 to-transparent opacity-50 block shadow-[0_0_15px_rgba(45,212,191,1)]" />
                                <div className="absolute inset-0 bg-gradient-to-tr from-teal-400/10 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />

                                <div className="relative z-10">
                                    <div className="w-10 h-10 rounded-full bg-teal-500/20 flex items-center justify-center mb-6 border border-teal-500/50 shadow-[0_0_15px_rgba(45,212,191,0.4)]">
                                        <Check className="w-5 h-5 text-teal-400" />
                                    </div>
                                    <h4 className="text-white font-black text-xl mb-2 flex items-center gap-2">
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500">Invisalign</span>
                                    </h4>
