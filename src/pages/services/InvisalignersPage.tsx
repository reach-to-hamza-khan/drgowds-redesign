                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-medical-pink leading-tight">
                                Best <span className="text-medical-purple italic">Invisalign Dentists</span> in Hyderabad!
                            </h1>
                            ...
                            <div className="flex gap-6 items-start">
                                <div className="hidden sm:flex self-start mt-2">
                                    <div className="bg-white p-4 rounded-3xl shadow-xl border-2 border-pink-100 flex items-center justify-center relative">
                                        ...
                                        <div className="absolute -top-3 -right-3 bg-blue-400 p-1 rounded-full shadow-md">
                                ...
                                <div className="space-y-4 pt-2">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <span className="text-gray-700 font-bold text-sm uppercase tracking-wider">Diamond Provider of Invisalign</span>
                                    </div>
                                    <div className="flex items-center space-x-3">
                                        <CheckCircle className="text-medical-purple w-5 h-5" />
                                        <span className="text-gray-700 font-bold text-sm uppercase tracking-wider">Customized digital scanning</span>
                                    </div>
                                    <div className="flex items-center space-x-3">
                                        <CheckCircle className="text-medical-purple w-5 h-5" />
                                        <span className="text-gray-700 font-bold text-sm uppercase tracking-wider">EMI options available</span>
                                    </div>
                                    <div className="flex items-center space-x-3">
                                        <CheckCircle className="text-medical-purple w-5 h-5" />
                                        <span className="text-gray-700 font-bold text-sm uppercase tracking-wider">Fast and effective</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative">
                            <div className="rounded-[40px] overflow-hidden shadow-2xl border-4 border-white bg-white p-2">
                                <img
                                    src="https://images.unsplash.com/photo-1593054941142-554b17f3d676?auto=format&fit=crop&q=80&w=800"
                                    alt="Invisalign Team"
                            ...
                            <div className="absolute -bottom-8 -left-8 w-40 h-40 rounded-2xl border-4 border-white shadow-2xl overflow-hidden hidden lg:block">
                                <img src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=300" alt="Clinic Interior" className="w-full h-full object-cover" />
                            </div>
                            <div className="absolute top-10 -right-8 w-32 h-32 rounded-full border-4 border-white shadow-2xl overflow-hidden hidden lg:block bg-white p-2">
                                <img src="https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&q=80&w=200" alt="Dental Care" className="w-full h-full object-cover rounded-full" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="flex items-center space-x-4 bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                ...
                                <span className="text-xl font-bold text-gray-700">What is Invisalign?</span>
                            </div>
                            <div className="flex items-center space-x-4 bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                <div className="bg-white p-2 rounded-full shadow-sm text-medical-pink">
                                    <CheckCircle2 size={32} />
                                </div>
                                <span className="text-xl font-bold text-gray-700">Process of Invisalign</span>
                            </div>
                            <div className="flex items-center space-x-4 bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                <div className="bg-white p-2 rounded-full shadow-sm text-medical-pink">
                                    <CheckCircle2 size={32} />
                                </div>
                                <span className="text-xl font-bold text-gray-700">Why Invisalign?</span>
                            </div>
                        </motion.div>
