...
import { fullMouthRehabilitationFAQs } from '../../data/faqs';
...
const FullMouthRehabPage = () => {
    const [activeImage, setActiveImage] = useState("/images/What is it.jpg");
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* HERO SECTION */}
            <Hero title={<>Rebuild Your Smile, <span className="text-medical-pink">Restore Your Confidence</span></>} />
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                            ...
                            {[
                                {
                                    id: 1,
                                    title: "What is it?",
                                    description: "Full mouth rehabilitation is a personalized treatment to restore oral health, function, and aesthetics.",
                                    image: "/images/What is it.jpg"
                                },
                                {
                                    id: 2,
                                    title: "Why to Choose?",
                                    description: "Restoring missing teeth, repairing injuries, and treating gum disease for healthier, confident smiles.",
                                    image: "/images/Why to Choose.jpg"
                                },
                                {
                                    id: 3,
                                    title: "What's the process?",
                                    description: "We assess your needs, restore function, and provide ongoing care for lasting results.",
                                    image: "/images/What's the process.jpg"
                                }
                            ].map((tab, idx) => (
                                <motion.div
                                    key={tab.id}
                        ...
                        <div className="relative group">
                            ...
                            >
                                <img
                                    src={activeImage}
                                    alt="Full Mouth Rehabilitation Anatomy"
                                ...
                                <div className="absolute bottom-8 left-8 right-8 text-white translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                                    <p className="text-lg font-bold italic">Advanced Rehabilitation Care</p>
            ...
            <MediaNews />
            <QuickForm />
            <FAQ faqs={fullMouthRehabilitationFAQs} />
        </div>
    );
};
